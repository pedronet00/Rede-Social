...
if($_SESSION['logado'] == false){
    ...
    $query_usuario = "SELECT * FROM logins WHERE usuario = '$usuario'";
    $result_query_usuario = mysqli_query($conn, $query_usuario);
...
<div class="container">
  <div class="profile-header">
    <div class="profile-img">
      <img src="<?php while($linha_query_usuario = mysqli_fetch_assoc($result_query_usuario)){echo $linha_query_usuario['foto'];} ?>" width="200" alt="Profile Image">
    </div>
    <div class="profile-nav-info">
      <h3 class="user-name"><?php echo $usuario;?></h3>
      <div class="address">
      ...
      <div class="profile-side">
        ...
        <div class="profile-btn">
          ...
          <?php if($usuario != $_SESSION['usuario']){?>
            ...
            <button class="createbtn" id="Create-post"><i class="fa fa-plus"></i> Seguir</button>
          <?php } ?>
        </div>
